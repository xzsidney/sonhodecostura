        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                <ul class="navbar-nav align-items-center gap-3">
                    <li class="nav-item">
                        <a class="nav-link fw-medium" href="{{ url('/') }}">Início</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link fw-medium" href="#colecao">Nossa Coleção</a>
                    </li>
                    <li class="nav-item">
                        <a class="btn btn-primary-custom" href="https://wa.me/5511985497329?text=Olá, vim pelo site e gostaria de solicitar um orçamento." target="_blank">Faça seu Orçamento</a>
                    </li>
                </ul>
            </div>
        </div>
